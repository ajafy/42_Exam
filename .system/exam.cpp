...
exam::exam(void) : exam_grade(0), level(0), level_max(0), failures(0), student(false), backup(false), using_cheatcode(0), my_ex(0)
{
    reelmode = true;
    waiting_time = true;
	vip = 0;
...
void exam::up_ex(void)
{
    my_ex++;
}

void exam::reset_ex(void)
{
    my_ex = 0;
}
